...
public class ConfigKeys {
    public static final String NUM_PARTITIONS_MAX_KEY = "metadata.numPartitionsMax";
    public static final String NUM_PARTITIONS_DEFAULT_KEY = "metadata.numPartitionsDefault";
    public static final String REPLICATION_FACTOR_DEFAULT_KEY = "metadata.replicationFactorDefault";
